...
export function SubNavigation() {
  ...
  return (
    <div className="sticky top-0 z-[49] -mt-2.5 overflow-hidden border-b border-border bg-muted shadow-[inset_0_-1px] shadow-black/10 dark:shadow-white/10">
      <div
        ref={containerRef}
        className="flex h-[46px] items-center px-2 md:px-4 [&>*]:shrink-0 transition-transform duration-50 ease-linear"
        style={{
