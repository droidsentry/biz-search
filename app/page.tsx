    ...
    <div className="relative h-dvh overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-12 px-4 max-w-2xl mx-auto">
        ...
        <div className="mx-auto flex h-20 w-20 items-center justify-center">
          <Image src={logo} alt="BizSearch" width={80} height={80} className="drop-shadow-lg" />
        </div>
        ...
        {/* CTAボタン */}
        <div className="pt-8">
            <Button size="lg" className="min-w-[200px] shadow-lg hover:shadow-xl transition-all duration-200" asChild>
              <Link href="/login">
                  検索を開始
              </Link> 
            </Button>
