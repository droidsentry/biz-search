...
export function CompanyInfoSidebar({ ownerId, initialCompanies }: CompanyInfoSidebarProps) {
  ...
  // 編集中のデータ
  const [editingData, setEditingData] = useState<Record<number, {
    companyName: string
  ...
  const handleDelete = async (rank: 1 | 2 | 3) => {
    ...
    setIsLoading(true)
    try {
      const result = await deleteOwnerCompanyAction(ownerId, rank)
  ...
  return (
    <div className="bg-background border border-muted-foreground/20 rounded-lg p-6">
      ...
      <div className="space-y-8">
        {[1, 2, 3].map((rank) => (
          <div key={rank} className="space-y-4 pb-6 border-b border-muted-foreground/20 last:border-0">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => updateField(rank, 'companyName', e.target.value)}
                  placeholder="株式会社○○"
                  disabled={isLoading}
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => updateField(rank, 'companyNumber', e.target.value)}
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => updateField(rank, 'position', e.target.value)}
                  placeholder="代表取締役"
                  disabled={isLoading}
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => updateField(rank, 'sourceUrl', e.target.value)}
              ...
              <Button
                ...
                disabled={isLoading || (!editingData[rank].companyName || !editingData[rank].sourceUrl)}
                size="sm"
                className="w-full"
              >
